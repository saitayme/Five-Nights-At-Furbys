...
#include "Furby/TP_WeaponComponent.h"
...
FURBY_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
FURBY_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AFurbyCharacter* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AFurbyCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2967102460
...
template<> FURBY_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_David_OneDrive_Dokumente_GitHub_Five_Nights_At_Furbys_Furby_Source_Furby_TP_WeaponComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 643114504U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_David_OneDrive_Dokumente_GitHub_Five_Nights_At_Furbys_Furby_Source_Furby_TP_WeaponComponent_h_522979551(TEXT("/Script/Furby"),
	Z_CompiledInDeferFile_FID_Users_David_OneDrive_Dokumente_GitHub_Five_Nights_At_Furbys_Furby_Source_Furby_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_David_OneDrive_Dokumente_GitHub_Five_Nights_At_Furbys_Furby_Source_Furby_TP_WeaponComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
